...
(function() {
    ...
    var studentModel = {
        ...
        init: function() {
            ...
            if (!localStorage.attendance) {
                ...
                localStorage.attendance = JSON.stringify(self.students);
            }
            else {
                self.students = JSON.parse(localStorage.attendance);
            }
        }
    }
    ...
    var octopus = {
        ...
        updateStudentAttendance: function(student, attendanceId) {
            ...
            localStorage.attendance = JSON.stringify(studentModel.students);
        },
